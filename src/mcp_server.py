...
class MCPAcademicServer:
    ...
    """
    def __init__(self, server_name: str = "ai20k-course-mcp-server"):
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            content = {"status": "INVALID_TOOL_OUTPUT", "raw": raw_result}
...
if __name__ == "__main__":
    print("==========================================================")
    print("🔌 KIỂM THỬ ĐỘC LẬP MCP SERVER (ai20k-course-mcp-server)")
    print("==========================================================")
    ...
    sched_tool = next((t for t in tools if t.get("name") == "book_mentor_session"), None)
    if sched_tool and not sched_tool.get("parameters", {}).get("properties"):
        print("⏳ [TODO 1.2]: Tool 'book_mentor_session' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TODO 1.2]: Tool 'book_mentor_session' đã có schema đầy đủ.")

    # Kiểm tra trạng thái TODO 2.1 (call_tool)
    test_result = server.call_tool("learner_progress_query", {"learner_id": "AI20K-K4A-001"})
    if not test_result:
        print("⏳ [TODO 2.1]: Hàm call_tool() đang trả về rỗng. Học viên hãy hoàn thiện TODO 2.1 trong 'src/mcp_server.py'!")
    else:
        print(f"✅ [TODO 2.1]: Test dispatch tool 'learner_progress_query' thành công:")
